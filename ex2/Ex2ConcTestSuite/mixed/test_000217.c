 ...
 *
 * Derived from minimised corpus file: ex2/Ex2Harness/minimized_corpus/id:000217,src:000148,time:622701,op:havoc,rep:8
 * Total decoded steps: 146
 *
 * Compile (from ex2/Ex2ConcTestSuite/mixed/):
 *   gcc -g -fsanitize=address -o test_000217 test_000217.c  *       ../../../TreeTable/treetable.c -I ../../../TreeTable/
 * Run:
 *   ./test_000217
 */
#include <stdio.h>
...
int main(void)
{
    ...
    /* step 0: treetable_add(key=16842753, val=50462720) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 16842753; *v = 50462720;
        treetable_add(t, k, v);
        assert(balanced(t) && sorted(t));
    }
    /* step 1: treetable_get(key=-1212678400) */
    { int k = -1212678400; void *out = NULL; treetable_get(t, &k, &out); }
    ...
    { int k = 1; void *out = NULL; treetable_get_greater_than(t, &k, &out); }
    /* step 5: treetable_get(key=50529027) */
    ...
    { int k = 50529027; void *out = NULL; treetable_get_greater_than(t, &k, &out); }
    /* step 144: treetable_get_greater_than(key=197379) */
    { int k = 197379; void *out = NULL; treetable_get_greater_than(t, &k, &out); }
    /* step 145: treetable_add(key=-16580096, val=50462720) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = -16580096; *v = 50462720;
        treetable_add(t, k, v);
        assert(balanced(t) && sorted(t));
    }
