 ...
 *
 * Derived from minimised corpus file: ex2/Ex2Harness/minimized_corpus/id:000016,src:000000,time:50,op:flip2,pos:1
 * Total decoded steps: 5
 *
 * Compile (from ex2/Ex2ConcTestSuite/mixed/):
 *   gcc -g -fsanitize=address -o test_000016 test_000016.c  *       ../../../TreeTable/treetable.c -I ../../../TreeTable/
 * Run:
 *   ./test_000016
 */
#include <stdio.h>
