 ...
 *
 * Derived from minimised corpus file: ex2/Ex2Harness/minimized_corpus/id:000215,src:000148,time:622386,op:havoc,rep:16
 * Total decoded steps: 194
 *
 * Compile (from ex2/Ex2ConcTestSuite/mixed/):
 *   gcc -g -fsanitize=address -o test_000215 test_000215.c  *       ../../../TreeTable/treetable.c -I ../../../TreeTable/
 * Run:
 *   ./test_000215
 */
#include <stdio.h>
...
int main(void)
{
    ...
    /* step 0: treetable_add(key=1, val=1024) */
    {
    ...
    /* step 2: treetable_add(key=1048577, val=16777215) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 1048577; *v = 16777215;
        treetable_add(t, k, v);
        assert(balanced(t) && sorted(t));
    }
    /* step 3: treetable_add(key=16843009, val=16843009) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
    ...
    { int k = 16843009; void *out = NULL; treetable_get(t, &k, &out); }
    /* step 128: treetable_get(key=31392001) */
    { int k = 31392001; void *out = NULL; treetable_get(t, &k, &out); }
    ...
    { int k = 16843009; void *out = NULL; treetable_get(t, &k, &out); }
    /* step 184: treetable_get(key=16843021) */
    { int k = 16843021; void *out = NULL; treetable_get(t, &k, &out); }
    ...
    { int k = 16843009; void *out = NULL; treetable_get(t, &k, &out); }
    /* step 189: treetable_get(key=5570817) */
    { int k = 5570817; void *out = NULL; treetable_get(t, &k, &out); }
    /* step 190: treetable_add(key=48300032, val=520093955) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 48300032; *v = 520093955;
        treetable_add(t, k, v);
        assert(balanced(t) && sorted(t));
    }
    /* step 191: treetable_add(key=58881, val=66306) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 58881; *v = 66306;
    ...
    /* step 192: treetable_add(key=16974336, val=16777216) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 16974336; *v = 16777216;
        treetable_add(t, k, v);
        assert(balanced(t) && sorted(t));
    }
    /* step 193: treetable_add(key=-803864577, val=1) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = -803864577; *v = 1;
