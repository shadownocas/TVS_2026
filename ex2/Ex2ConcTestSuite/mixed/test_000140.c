 ...
 *
 * Derived from minimised corpus file: ex2/Ex2Harness/minimized_corpus/id:000140,src:000079,time:68191,op:flip1,pos:47
 * Total decoded steps: 9
 *
 * Compile (from ex2/Ex2ConcTestSuite/mixed/):
 *   gcc -g -fsanitize=address -o test_000140 test_000140.c  *       ../../../TreeTable/treetable.c -I ../../../TreeTable/
 * Run:
 *   ./test_000140
 */
#include <stdio.h>
...
int main(void)
{
    ...
    /* step 4: treetable_add(key=51200, val=16799071) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 51200; *v = 16799071;
    ...
    /* step 7: treetable_get(key=33554432) */
    { int k = 33554432; void *out = NULL; treetable_get(t, &k, &out); }
