 ...
 *
 * Derived from minimised corpus file: ex2/Ex2Harness/minimized_corpus/id:000060,src:000000,time:1095,op:havoc,rep:4
 * Total decoded steps: 6
 *
 * Compile (from ex2/Ex2ConcTestSuite/mixed/):
 *   gcc -g -fsanitize=address -o test_000060 test_000060.c  *       ../../../TreeTable/treetable.c -I ../../../TreeTable/
 * Run:
 *   ./test_000060
 */
#include <stdio.h>
