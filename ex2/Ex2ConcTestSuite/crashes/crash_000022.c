 ...
 *
 * Derived from AFL++ crash input: ex2/Ex2Harness/outputs/crashes/id:000022,sig:06,src:000018,time:33338,op:havoc,rep:8
 * Total decoded steps: 15
 *
 ...
 *   ./harness_fuzz < "ex2/Ex2Harness/outputs/crashes/id:000022,sig:06,src:000018,time:33338,op:havoc,rep:8"
 *
 * Compile this test (from ex2/Ex2ConcTestSuite/crashes/):
 *   gcc -g -fsanitize=address -o crash_000022 crash_000022.c  *       ../../../TreeTable/treetable.c -I ../../../TreeTable/
 *
...
int main(void)
{
    ...
    /* step 5: treetable_add(key=1507528, val=32513) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 1507528; *v = 32513;
    ...
    /* step 6: treetable_add(key=131842, val=-939524096) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 131842; *v = -939524096;
        treetable_add(t, k, v);
        assert(balanced(t) && sorted(t));  /* <-- crash fires here or above */
    }
    /* step 7: treetable_add(key=16842752, val=33554432) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
    ...
    /* step 8: treetable_get_greater_than(key=2) */
    { int k = 2; void *out = NULL; treetable_get_greater_than(t, &k, &out); }
    /* step 9: treetable_add(key=33554532, val=515) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 33554532; *v = 515;
    ...
    /* step 10: treetable_add(key=25600, val=131072) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 25600; *v = 131072;
    ...
    /* step 11: treetable_add(key=65280, val=6553600) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 65280; *v = 6553600;
    ...
    /* step 12: treetable_add(key=131072, val=13107200) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 131072; *v = 13107200;
    ...
    /* step 13: treetable_add(key=65792, val=50462720) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = 65792; *v = 50462720;
