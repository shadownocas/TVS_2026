 ...
 *
 * Derived from AFL++ crash input: ex2/Ex2Harness/outputs/crashes/id:000015,sig:06,src:000000,time:1189,op:havoc,rep:128
 * Total decoded steps: 14
 *
 ...
 *   ./harness_fuzz < "ex2/Ex2Harness/outputs/crashes/id:000015,sig:06,src:000000,time:1189,op:havoc,rep:128"
 *
 * Compile this test (from ex2/Ex2ConcTestSuite/crashes/):
 *   gcc -g -fsanitize=address -o crash_000015 crash_000015.c  *       ../../../TreeTable/treetable.c -I ../../../TreeTable/
 *
