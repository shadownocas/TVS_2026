 ...
 *
 * Derived from AFL++ crash input: ex2/Ex2Harness/outputs/crashes/id:000002,sig:06,src:000000,time:632,op:int32,pos:10,val:-2147483648
 ...
 *   ./harness_fuzz < "ex2/Ex2Harness/outputs/crashes/id:000002,sig:06,src:000000,time:632,op:int32,pos:10,val:-2147483648"
 *
 * Compile this test (from ex2/Ex2ConcTestSuite/crashes/):
 *   gcc -g -fsanitize=address -o crash_000002 crash_000002.c  *       ../../../TreeTable/treetable.c -I ../../../TreeTable/
 *
...
int main(void)
{
    ...
    /* step 1: treetable_add(key=-2147483648, val=200) */
    {
        int *k = malloc(sizeof(int));
        int *v = malloc(sizeof(int));
        *k = -2147483648; *v = 200;
