...
#
# Usage:
#   ./decode_crash.sh <crash_file>
#   ./decode_crash.sh outputs/crashes/id:000015,...
...
read_int32() {
    # reads 4 bytes little-endian from BYTES starting at index $1
    # sets global READ_VAL and advances READ_CUR
    local idx=$1
    if (( idx + 4 > TOTAL )); then
        READ_VAL=""
        return 1
